...
import funcionesLecturaSensoresPruebaFuncionamiento2 # type: ignore
...
try:
    ...
    if (internet == True):
        ...
        db = iniciarFirestore()
        hiloLectura = threading.Thread(target=funcionesLecturaSensoresPruebaFuncionamiento2.lecturaSensores, args=(varCompartidas, UVOUT, BATERYOUT, outRelay, dhtDeviceExterior, dhtDeviceBateria, ads, ser, i2c, interfaz, db))
        time.sleep(1)
        hiloLectura.start()
