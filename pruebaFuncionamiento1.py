...
import funcionesLecturaSensoresPruebaFuncionamiento1 # type: ignore
...
try:
    ...
    if (internet == True):
        ...
        db = iniciarFirestore()
        #hiloLectura = threading.Thread(target=funcionesLecturaSensoresPruebaFuncionamiento1.lecturaSensores, args=(varCompartidas, UVOUT, BATERYOUT, outRelay, dhtDeviceExterior, dhtDeviceBateria, ads, ser, i2c, interfaz, db))
        funcionesLecturaSensoresPruebaFuncionamiento1.lecturaSensores(varCompartidas, UVOUT, BATERYOUT, outRelay, dhtDeviceExterior, dhtDeviceBateria, ads, ser, i2c, db)
        #time.sleep(1)
        #hiloLectura.start()
